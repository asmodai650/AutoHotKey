...
MsgBox, In your Excel workbook, select the cell in column F next to the account you want to start with. Now log into Direct Connect.  Column A should contain the UID#, column B New Request Category "Need Additional Information", and column C should contain new request comments.
