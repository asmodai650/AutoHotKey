...
Send, {Tab}
Sleep, 500
Send, This claim has been submitted for offset attempts. Please be advised that the retraction process is not a guarantee and a refund check may be required in the future.
Sleep, 500
Send, {Tab}
Sleep, 500
Send, {Tab}
