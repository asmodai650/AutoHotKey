...
MsgBox, In your Excel workbook, select the cell in column F next to the account you want to start with. Now log into Direct Connect.  Column A should contain the UID#, column B New Request Category "Approved", column c should contain New request Subject of "Please Process Refund Check", column D should contain new request comments.
...
Send, {TAB}
Sleep, 500
Send, {Enter} ;hits save & close button
Sleep, 5000
