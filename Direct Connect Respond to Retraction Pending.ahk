...
MsgBox, In your Excel workbook, select the cell in Column D next to the UID you want to start with. Column A should contain UID, column B contains the Macro Subject, and column C contains the Macro Comment. Now log into Direct Connect under UnitedHealthcare.
