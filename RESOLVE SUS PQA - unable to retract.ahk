...
Description: 	This resolves suspense claims with a specific note back to RAM. The reason MUST be Close Pass QA. 
...
Send, UHC was unable to offset this refund, please pursue a cash payment.
Sleep, 600
