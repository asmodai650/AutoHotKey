...
;Check CBO
	...
	mouseclickdrag, left, 940, 152, 1279, 152
	Send, ^c
	ClipWait, 2
		
		If clipboard contains %CBO%
			{
				Clipboard = 
				GoTo, REQUEST
			}
		; If the correct CBO is not selected, select the correct CBO
			Else
				{
					MouseClick Left, 148, 157
					Sleep, 2000
					Send, {Home}
					Sleep, 750
					Send, {Tab}
...
RESOLVE1:
{
MouseClickDrag left, 990, 400, 1030, 400
Send, ^c
ClipWait, 2

	If clipboard contains CBD
	{
		Clipboard = 
		GoTo, ResolveCBD
	}
...
MouseClickDrag, left, 47, 280, 185, 280
Sleep, 500
Send, {TAB}
Sleep, 500
Send, {TAB}
